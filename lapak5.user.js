// ==UserScript==
// @name         LAPAK5 - Custom Chat Word Highlighter with Dashboard (PREMIUM UI)
...
(function () {
    ...
    function updateCSS() {
        ...
        let css = `
            ...
            /* GLOSSY GLASSMORPHISM EFFECT FOR css-tf26ca - BENING KACA PUTIH */
            .css-tf26ca,
            [class*="css-tf26ca"] {
                ...
                box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.15), inset 0 1px 2px rgba(255, 255, 255, 0.5) !important;
            ...
            .css-tf26ca:hover,
            [class*="css-tf26ca"]:hover {
                background: linear-gradient(135deg, rgba(255, 255, 255, 0.3), rgba(255, 255, 255, 0.1)) !important;
                box-shadow: 0 12px 40px 0 rgba(0, 212, 255, 0.2), inset 0 1px 4px rgba(255, 255, 255, 0.6) !important;
